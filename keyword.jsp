...
<c:set var="formKeyword" value="${param.keyword}" />

<sql:setDataSource driver="org.h2.Driver" url="jdbc:h2:sdev" />

<c:choose>
  <c:when test="${empty formKeyword}">
    <sql:query var="rs">
  ...
  <c:otherwise>
    <sql:query var="rs">
     SELECT PRODUCT_CODE, PRODUCT_NAME, CATEGORY_NAME, MAKER_NAME, DETAIL, MATERIAL, SIZE, IMAGE, PRICE
     FROM PRODUCT_INFO WHERE PRODUCT_NAME = ? ORDER BY PRODUCT_CODE;
     <sql:param value="${formKeyword}" />
    </sql:query>
  </c:otherwise>
</c:choose>
                ...
                <div class="card my-3 item" style="width: 18rem">
                    ...
                    <div class="card-body">
                      ...
                      <div class="circle-button">
                          <button class="icobutton icobutton-3-ccc-red once"><span class="fa fa-heart"></span></button>
                      </div>
                      </div>
                </div>
          　 </FORM>
